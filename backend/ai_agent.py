...
# Example: Gemini API key (replace with your actual key or import from config)
GEMINI_API_KEY = "YOUR_GEMINI_API_KEY"
genai.configure(api_key=GEMINI_API_KEY)

# Example function to get response from Gemini model
def gemini_chat(prompt, model="gemini-pro"):
...
from config import GEMINI_API_KEY  # make sure this is set correctly

tools = [ask_mental_health_specialist, emergency_call_tool, find_nearby_therapists_by_location]

# Use Gemini-1.5-flash (fast, low-latency model)
